...
public class ServiceLocator extends org.apache.axis.client.Service implements com.safwenbouanen.ocr.webservice.Service {
 ...
 */
    ...
    private java.lang.String Service_address = "http://localhost:80";
    ...
    public com.safwenbouanen.ocr.webservice.ServicePortType getService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.safwenbouanen.ocr.webservice.ServiceStub _stub = new com.safwenbouanen.ocr.webservice.ServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.safwenbouanen.ocr.webservice.ServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.safwenbouanen.ocr.webservice.ServiceStub _stub = new com.safwenbouanen.ocr.webservice.ServiceStub(new java.net.URL(Service_address), this);
                _stub.setPortName(getServiceWSDDServiceName());
                return _stub;
            }
        }
